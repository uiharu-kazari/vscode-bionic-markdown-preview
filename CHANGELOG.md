...
### Changed
- Updated descriptions and terminology for clarity
...
- Customizable settings:
  - Leading (fixation point): 1-5 characters
  - Opacity: 0-100%
  - Gradient theme selection
  - Font size: 12-24px
  - Line height: 1.2-2.0
- Built-in toolbar for quick adjustments
- Commands:
  - Open Bionic Preview
  - Open Bionic Preview to the Side
